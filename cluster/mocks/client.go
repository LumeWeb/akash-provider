...
func (_m *Client) ConnectHostnameToDeployment(ctx context.Context, directive hostname.ConnectToDeploymentDirective, tlsEnabled bool) error {
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, hostname.ConnectToDeploymentDirective, bool) error); ok {
...
func (_c *Client_ConnectHostnameToDeployment_Call) Run(run func(ctx context.Context, directive hostname.ConnectToDeploymentDirective, tlsEnabled bool)) *Client_ConnectHostnameToDeployment_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(hostname.ConnectToDeploymentDirective), args[2].(bool))
	})
	return _c
}
...
func (_c *Client_ConnectHostnameToDeployment_Call) RunAndReturn(run func(context.Context, hostname.ConnectToDeploymentDirective, bool) error) *Client_ConnectHostnameToDeployment_Call {
	_c.Call.Return(run)
	return _c
}
